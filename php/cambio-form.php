...
<div>
	...
	<input type="radio" id="m" name="sexo_rdo" title="Tu sexo" value="F" <?php if($registro_contacto["sexo"] == "F"){ echo "checked";} ?> required /> &nbsp; <label for="f">Femenino</label>			
</div>
<div>
...
<div>
	...
	<input type="number" id="numero" class="cambio" name="telefono_txt" title="Tu telefono" placeholder="Escribe tu telefono" value="<?php echo $registro_contacto["telefono"]; ?>" required />
</div>
<div>
...
<div>
	<input type="submit" class="cambio" id="enviar-cambio" value="Modificar" name="enviar_btn"/>
</div>
